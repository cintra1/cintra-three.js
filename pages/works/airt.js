...
const Work = () => (
  <Layout title="Airt">
    <Container>
      ...
      <P>
      A visual experience powered by Art, CSS and JavaScript effects. The images are generated by artificial intelligence, using my favorite painters as a base.
      </P>
      <List ml={4} my={4}>
        <ListItem>
          <Meta>Website</Meta>
